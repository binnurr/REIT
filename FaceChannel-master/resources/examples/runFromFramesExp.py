    ...
    def process_request(self, question, start_time, end_time, time_relative=False):
        ...
        with open(result_fp, mode="a") as employee_file:
            ...
            while cap.isOpened() and not frame_count == total:
                ...
                cv2.imwrite(os.path.join('/usr/share/resources/experiment/frames', str(question)+'_'+str(frame_count) + ".png"), frame)
...
if __name__ == "__main__":
    ...
    load_video_fp = "/usr/share/resources/experiment/videos_exp2"
    request_fp = "/usr/share/resources/experiment/requests/exp2_post"
    result_fp = "/usr/share/resources/experiment/results/exp2_post"
