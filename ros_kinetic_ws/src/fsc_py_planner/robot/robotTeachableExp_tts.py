...
class Robot():
    ...
    def __init__(self, rospy, session_mode, scenario_id):
        ...
        self.text_to_say_pub = self.rospy.Publisher("text_to_say", String, queue_size=10)
    ...
    def init_web_driver(self):
        ...
        self.driver = webdriver.Chrome(r"/home/catkin_ws/src/chromedriver",
    ...
    def load_feedback_file(self):
        feedback_file_name = '/home/catkin_ws/sounds/re_feedback_en.txt'
        ...
        self.feedback_exp_dict = {
            ...
            'Asking long question': 'You asked long or complex question. '
        ...
        self.feedback_alt_exp_dict = {
            'No rapport with customer': [
                'You did not show rapport with customer. There are some ways of doing it. For example do not forget to thank customer for their time. ',
            ...
            'Asking customer for solution': [
                'You asked customer for solution. Do not ask questions like How do you want the system to manage reservations?',
            ...
            'Influencing customer': [
                'Your choice in here may influence the customer. Do not influence the customer towards a particular solution.'],
            'Asking vague question': ['You should not ask unclear questions. '
    ...
    def google_speech_recognition(self):
        ...
        list_of_files = glob.glob('/home/catkin_ws/*.wav')
    ...
    def say_text(self, text):
        try:
            ...
            self.say_text_func(text)
        except:
            pass

    def say_text_func(self, text):
        text_to_say = text
        # we cannot find audio file, run text to speech
        if (text in self.sound_file_texts.keys()):
            text_to_say = self.sound_file_texts[text]

        self.say_text_remote(text_to_say)
        self.say_finished = True

    def say_text_remote(self, text_to_say):
        print("Publishing ", text_to_say)
        self.text_to_say_pub.publish(String(text_to_say))

    def say_text_local(self, text_to_say):
